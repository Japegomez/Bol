...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get leaveHouseholdMessage =>
      'Perderá acesso ao planificador e lista partilhados. Continuar?';
  ...
  String get recipeAssistantDescription =>
      'Descreva o prato que quer criar: só o nome ou uma receita detalhada com ingredientes e passos.';
  ...
  @override
  String stepXofY(int current, int total) => 'Passo $current de $total';
  ...
  String cookingInProgressMessage(String title) =>
      'Já está a cozinhar "$title". Iniciar uma nova receita?';
