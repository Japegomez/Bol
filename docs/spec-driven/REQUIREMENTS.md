...
**RF-PLAN-15** Al asignar o mover una receta a un **día calendario ya pasado** (respecto a hoy local), la app muestra un aviso y **no añade** (o quita, si se mueve desde un día futuro) los ingredientes de esa asignación en la lista de la compra. Mover de un día pasado a hoy/futuro vuelve a sincronizar ingredientes si la comida no es sobras.
